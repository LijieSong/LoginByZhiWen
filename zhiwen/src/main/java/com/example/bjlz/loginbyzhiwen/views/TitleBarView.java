package com.example.bjlz.loginbyzhiwen.views;
...
import com.example.bjlz.loginbyzhiwen.tools.tools.DP2PXTools;
...
//      this.view_title.setBackgroundColor(CommonUtil.getColor(R.color.black));
  ...
  public void setCommonVisible(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.btnRight.setVisibility(paramInt2);
    this.txtTitle.setVisibility(paramInt3);
  }
