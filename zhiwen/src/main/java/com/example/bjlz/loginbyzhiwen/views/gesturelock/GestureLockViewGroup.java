package com.example.bjlz.loginbyzhiwen.views.gesturelock;
...
import com.example.bjlz.loginbyzhiwen.tools.tools.CommonUtil;
import com.example.bjlz.loginbyzhiwen.views.gesturelock.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout
{
	 ...
	 * 存储答案
	 */
	private int[] mAnswer = new int[12];
	/**
...
//	private int mNoFingerInnerCircleColor = CommonUtil.getColor(R.color.gold);
	/**
